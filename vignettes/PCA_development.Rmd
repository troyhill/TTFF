...
if(!"COPmod" %in% installed.packages()){
...
rainDat  <- system.file("extdata", "data_Daily_Rain.txt", package = "COPmod")
PETDat   <- system.file("extdata", "data_daily_PET.txt", package = "COPmod")
stageDat <- system.file("extdata", "data_ALT_output_stage.txt", package = "COPmod")
flowDat  <- system.file("extdata", "data_ALTO_output_Flows.txt", package = "COPmod") 
